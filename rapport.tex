...
\midrule
CVRP & data101.vrp & recuit simulé & 1741.85 & 1859.75 & 58.95 \\
...
Un premier test en mode \texttt{long} a ensuite été lancé sur l'instance \texttt{data101.vrp}, avec deux répétitions. La distance moyenne initiale observée est \(3719.84\). Dans ce cadre plus exigeant, le recuit simulé obtient une distance moyenne de \(1800.80\), alors que la recherche tabou recalibrée atteint \(2419.86\).

Les temps moyens associés à cette expérience sont d'environ \(0.54\) seconde pour le recuit simulé et \(0.85\) seconde pour la recherche tabou.
...
Nous avons ensuite appliqué le même protocole \texttt{long} à l'instance \texttt{data102.vrp}. La distance moyenne initiale obtenue est \(3609.70\). Le recuit simulé atteint alors une distance moyenne de \(1764.93\), tandis que la recherche tabou obtient \(2389.28\).

Les temps moyens observés sont du même ordre que pour \texttt{data101.vrp} : environ \(0.53\) seconde pour le recuit simulé contre environ \(0.84\) seconde pour la recherche tabou.
...
Pour \texttt{data1101.vrp}, la distance moyenne initiale observée est \(4801.67\). Le recuit simulé obtient une distance moyenne de \(2237.07\), tandis que la recherche tabou atteint \(3202.56\).
...
Les temps moyens restent faibles sur ces deux instances : environ \(0.63\) et \(0.66\) seconde pour le recuit simulé, contre environ \(1.05\) et \(1.09\) secondes pour la recherche tabou.
...
On observe ici :
\begin{itemize}
    \item \texttt{data111.vrp} : initiale \(3480.20\), recuit \(1716.46\), tabou \(2306.55\) ;
    \item \texttt{data112.vrp} : initiale \(3550.56\), recuit \(1819.29\), tabou \(2317.44\).
\end{itemize}

Les temps mesurés restent modestes pour les deux méthodes, autour de \(0.50\) à \(0.56\) seconde pour le recuit simulé et de \(0.86\) à \(0.95\) seconde pour la recherche tabou. Ces deux instances renforcent donc la cohérence de la tendance globale en faveur du recuit dans la version capacitaire.
...
Le point notable ici est que les deux méthodes deviennent très rapides : environ \(0.37\) à \(0.51\) seconde pour le recuit simulé et environ \(0.59\) à \(0.69\) seconde pour la recherche tabou.
...
Comme pour \texttt{data1201.vrp} et \texttt{data1202.vrp}, les temps restent très faibles : environ \(0.35\) à \(0.36\) seconde pour le recuit simulé et autour de \(0.59\) à \(0.60\) seconde pour la recherche tabou.
