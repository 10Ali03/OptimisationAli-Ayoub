...
\begin{itemize}
    ...
    \item prise en compte complète des fenêtres de temps dans la construction et l'amélioration des tournées.
\end{itemize}
...
\begin{itemize}
    ...
    \item implémenté un premier générateur aléatoire de solutions initiales faisables pour la version sans fenêtres de temps.
\end{itemize}

La suite du travail consistera à exploiter ce socle pour générer des solutions initiales faisables, définir des voisinages pertinents, puis développer et comparer deux métaheuristiques adaptées au problème.
